...
% This relates to the coupon collectors problem, but it's not exactly the
% same.  As an analogy, our problem is like buying packs of collectible
% cards where each individual pack contains only unique cards but two
% different packs may contain duplicates:
%
...
% See also:
% http://math.stackexchange.com/questions/131664/coupon-collector-problem-with-batched-selections
% http://math.stackexchange.com/questions/151267/coupon-collector-problem-for-collecting-set-k-times
